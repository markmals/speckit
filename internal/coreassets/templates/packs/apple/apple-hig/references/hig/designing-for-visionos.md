---
url: "https://developer.apple.com/design/human-interface-guidelines/designing-for-visionos?s=09"
...
**Immersion.** In a visionOS app, people can fluidly transition between different levels of [immersion](immersive-experiences.md). By default, an app launches in the _Shared Space_ where multiple apps can run side-by-side and people can open, close, and relocate windows. People can also choose to transition an app to a _Full Space_, where it’s the only app running. While in a Full Space app, people can view 3D content blended with their surroundings, open a portal to view another place, or enter a different world.
...
**Eyes and hands.** In general, people perform most actions by using their [eyes](eyes.md) to look at a virtual object and making an _indirect_ [gesture](gestures.md#visionOS), like a tap, to activate it. People can also interact with a virtual object by using a _direct_ gesture, like touching it with a finger.
...
**Help people share activities with others.** When you use [SharePlay](shareplay.md#visionOS) to support shared activities, people can view the _spatial Personas_ of other participants, making it feel like everyone is together in the same space.
