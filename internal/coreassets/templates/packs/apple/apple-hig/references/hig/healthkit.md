...
**Don’t use the Apple Health icon within text or as a replacement for the terms _Health_, _Apple Health_, or _HealthKit_.** See [Editorial guidelines](healthkit.md#Editorial-guidelines) to learn how to properly reference the Health app and HealthKit in text.
