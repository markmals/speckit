...
watchOS displays tab views using [page controls](page-controls.md). For developer guidance, see [`TabView`](https://developer.apple.com/documentation/SwiftUI/TabView).
