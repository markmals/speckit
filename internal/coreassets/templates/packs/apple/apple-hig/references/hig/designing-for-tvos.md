...
**Inputs.** People can use a [remote](remotes.md), a [game controller](game-controls.md), their [voice](siri.md), and apps running on their other devices to interact with Apple TV.
